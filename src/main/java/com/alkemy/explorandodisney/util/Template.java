...
public class Template {
    public String getHtmlTemplate(String token){
        String template = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">"+
                ...
                "<tr>"+
                "<td class=\"es-m-txt-c\" align=\"left\" style=\"padding:5px;Margin:0;font-size:0px\"><a target=\"_blank\" href=\"https://www.alkemy.org/\" style=\"-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2CB543;font-size:14px\"><img src=\"https://rywkbv.stripocdn.email/content/guids/CABINET_644cf5f8d241bbc7d07fe38d79c063e6/images/48121628726218193.png\" alt style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic\" height=\"28\"></a></td>"+
                "</tr>"+
                "</table></td>"+
                "</tr>"+
                "</table>"+
                "<!--[if mso]></td><td style=\"width:0px\"></td><td style=\"width:380px\" valign=\"top\"><![endif]-->"+
                "<table cellspacing=\"0\" cellpadding=\"0\" align=\"right\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">"+
                "<tr>"+
                "<td align=\"left\" style=\"padding:0;Margin:0;width:380px\">"+
                "<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">"+
                "<tr>"+
                "<td class=\"es-m-txt-c\" align=\"right\" style=\"padding:5px;Margin:0;font-size:0px\">"+
                "<table class=\"es-table-not-adapt es-social\" cellspacing=\"0\" cellpadding=\"0\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">"+
                "<tr>"+
                "<td valign=\"top\" align=\"center\" style=\"padding:0;Margin:0;padding-right:10px\"><a target=\"_blank\" href=\"https://twitter.com/alkemy__\" style=\"-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2CB543;font-size:14px\"><img title=\"Twitter\" src=\"https://rywkbv.stripocdn.email/content/assets/img/social-icons/circle-colored/twitter-circle-colored.png\" alt=\"Tw\" width=\"24\" height=\"24\" style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic\"></a></td>"+
                "<td valign=\"top\" align=\"center\" style=\"padding:0;Margin:0\"><a target=\"_blank\" href=\"https://www.instagram.com/alkemy__/\" style=\"-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2CB543;font-size:14px\"><img title=\"Instagram\" src=\"https://rywkbv.stripocdn.email/content/assets/img/social-icons/circle-colored/instagram-circle-colored.png\" alt=\"Inst\" width=\"24\" height=\"24\" style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic\"></a></td>"+
                "</tr>"+
                "</table></td>"+
                "</tr>"+
                "</table></td>"+
                ...
                "<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">"+
                "<tr>"+
                "<td align=\"center\" style=\"padding:0;Margin:0\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:18px;color:#333333;font-size:12px\">Your authentication token is: <strong> Bearer "+token+"</strong></p></td>"+
                "</tr>"+
                "</table></td>"+
                "</tr>"+
                "</table></td>"+
                ...
                "<tr>"+
                "<td align=\"center\" style=\"padding:0;Margin:0\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#999999;font-size:14px\">Don't forget to place it in the request headers to be able to access the respective endpoint.  It expires in 48 hours.</p></td>"+
                "</tr>"+
                "</table></td>"+
                "</tr>"+
                "</table></td>"+
                ...
                "<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">"+
                "<tr>"+
                "<td align=\"center\" style=\"padding:0;Margin:0;font-size:0px\"><img class=\"adapt-img\" src=\"https://rywkbv.stripocdn.email/content/guids/CABINET_644cf5f8d241bbc7d07fe38d79c063e6/images/44371628721066304.jpg\" alt style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic\" width=\"560\"></td>"+
                "</tr>"+
                "</table></td>"+
                "</tr>"+
                "</table></td>"+
